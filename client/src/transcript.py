...
class Answer:
    """The agent's text, streaming in; copied whole from the row under it once it's done."""
    ...
    def __init__(self, text: str = "", on_copy: Callable[[str], Any] | None = None,
        ...
        self.copy = t.icon_button(ft.Icons.CONTENT_COPY_ROUNDED, "Copy", size=15,
        ...
        self.view = ft.Column([self.md, self.actions], spacing=2)

    def set(self, text: str) -> None:
        self.md.value = text

    def finish(self) -> None:
        self.actions.visible = bool((self.md.value or "").strip())
...
class Thinking:
    ...
    def toggle(self, _event=None) -> None:
        ...
        self.chevron.name = ft.Icons.EXPAND_MORE_ROUNDED if self.body_box.visible else ft.Icons.CHEVRON_RIGHT_ROUNDED
        self.view.update()
...
class ToolCard:
    ...
    def toggle(self, _event=None) -> None:
        ...
        self.chevron.name = ft.Icons.EXPAND_MORE_ROUNDED if self.details.visible else ft.Icons.CHEVRON_RIGHT_ROUNDED
        self.view.update()
