...
`nanoborealis password` shows the password for the agent's web page; the NanoBorealis app doesn't need it
Want what's next? `nanoborealis update --testing` moves this computer to the testing build
Use `brew search` and `brew install` for command line tools
The agent can't reach your local network or your files outside its projects folder: `nanoborealis help` explains the sandbox
